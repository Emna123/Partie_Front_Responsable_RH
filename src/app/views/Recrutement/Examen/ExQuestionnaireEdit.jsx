...
class EXQuestionnaireEdit extends Component {
  ...
  componentWillMount = () => {
    for (var i = 0; i < this.props.questinfo.length; i++) {
      if (this.props.questinfo[i].idq == this.props.id && this.props.questinfo[i].idb != -1) {
        var ex = [];
        for (var j = 0; j < this.props.questinfo[i].repinfo.length; j++) {
          ex.push(<EXReponseEdit questinfo={this.props.questinfo} setquestinfo={this.props.setquestinfo} id={j} repinfo={this.props.repinfo} setrep={this.props.setrep} idquest={this.props.id}></EXReponseEdit>)
        }
        this.setState({
          question: this.props.questinfo[i].question,
          edit: false,
          note: this.props.questinfo[i].note,
          id: ex.length - 1,
          exrep: [...ex]
      ...
      else if (this.props.questinfo[i].idq == this.props.id && this.props.questinfo[i].idb == -1) {
        this.state.exrep.push(<EXReponseEdit questinfo={this.props.questinfo} setquestinfo={this.props.setquestinfo} id={j} repinfo={this.props.repinfo} setrep={this.props.setrep} idquest={this.props.id}></EXReponseEdit>)
  ...
  addrep = event => {
    this.state.exrep.push(<EXReponseEdit questinfo={this.props.questinfo} setquestinfo={this.props.setquestinfo} id={this.state.id + 1} repinfo={this.props.repinfo} setrep={this.props.setrep} idquest={this.props.id}></EXReponseEdit>)
    this.setState({ exrep: [...this.state.exrep] });
                ...
                <div className="col" style={{ textAlign: 'left', width: '5%', marginLeft: 0, lineHeight: 0 }}   >
                  ...
                  <IconButton
                    ...
                    style={{ border: 'solid 2px  #909497', borderRadius: '3px', padding: '6.2px' }} aria-label="Delete" onClick={e => {
                      ...
                      if (x != -1) {
                        if (this.props.questinfo[idquest].repinfo[x].idb != -1) {
                          this.props.deleterep.push(this.props.questinfo[idquest].repinfo[x].idb)
                          this.props.setdeleterep(this.props.deleterep)
                        }
...
export default withStyles(styles, { withTheme: true })(EXQuestionnaireEdit);
