...
class ExemainInfoEdit extends Component {




  state = {
    duree: this.props.exinfo.duree,
    nombreq: this.props.exinfo.nombreq,
    titre: this.props.exinfo.titre,
    id: this.props.exinfo.id,
    edit: false,
  }
              ...
              <div style={{ textAlign: "left", fontSize: '14px' }}>
                <div style={{ color: '#7467ef', fontSize: '14px' }}  >
                  ...
                  <div style={{ marginTop: '-5%', marginBottom: '9%' }}>
                    ...
                    <IconButton style={{
                      border: 'solid 2px  #7467ef', float: 'right', borderRadius: '3px', padding: '6px'
                      , backgroundColor: '#7467ef'
                    }} aria-label="Delete"
                      className="mt-4"
                      onClick={e => {
...
export default withStyles(styles, { withTheme: true })(ExemainInfoEdit);
